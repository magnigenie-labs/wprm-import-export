...
= 1.1.8 =
* Improved: Redesigned all 15 Pro templates with vibrant, highly professional color palettes, sleek dark modes, gold-accented typography, and optimized contrast values.
* Improved: Redrew all 15 Pro thumbnail images to match the new redesigned high-contrast palettes, ensuring they align perfectly with the imported outputs.
